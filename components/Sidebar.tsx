...
export const Sidebar: React.FC<SidebarProps> = ({ currentPage, onNavigate, currentStore, hasUnread, isMobileDrawer }) => {
  ...
  // AI Button
  menuItems.push({ id: 'ai', label: 'AI 助手', icon: Icons.Sparkles });
  ...
  return (
    <div className={`h-full bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 flex flex-col shrink-0 shadow-xl z-50 ${isMobileDrawer ? 'w-full' : 'w-72'}`}>
      <div className="p-6 flex items-center space-x-4 border-b border-gray-100 dark:border-gray-800">
        <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center shadow-lg border border-gray-100 overflow-hidden shrink-0">
          <img src="retouch_2025121122511132.png" alt="Logo" className="w-10 h-10 object-contain" />
        </div>
        <div>
